...
\begin{tikzpicture}[
    ...
    \draw[serie, blue!70!black] (4.9,4.55) -- (5.4,4.55);
    \node[legenda, anchor=west] at (5.5,4.55) {Original};
    \draw[serie, red!70!black] (4.9,4.25) -- (5.4,4.25);
    \node[legenda, anchor=west] at (5.5,4.25) {Otimizada};
\end{tikzpicture}
}}
