...
\author{
Dalton Solano dos Reis \qquad Andre Tavares da Silva\\[0.5em]
\small Programa de Pós-Graduação em Computação Aplicada (PPGCAP)\\
\small Universidade do Estado de Santa Catarina (UDESC)\\
\small\texttt{dalton@furb.br} \qquad
\small\texttt{andre.silva@udesc.br}
}
\date{2026}
